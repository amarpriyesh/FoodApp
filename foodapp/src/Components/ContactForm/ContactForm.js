      ...
      <div>
        <form 
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col">
              <button disabled={disabled} type="submit" class="rounded-md bg-[#d64b7d] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#d64b7d] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Send</button>
            </div>
          </div>
        </form>
      </div>
